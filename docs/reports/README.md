...
### 5. プレビュー機能
- **リアルタイムプレビュー**: フィールド入力中と画像アップロード中にサイドパネルでリアルタイムにプレビューを表示
- **確認画面**: 最終確認用のプレビュー画面
- タイトル、テンプレート名、入力内容、アップロード済み画像を表示
- デスクトップ（lg以上）ではサイドパネルで常時表示、モバイルでは非表示
...
└── features/
    └── report/
        └── components/
            ...
            └── report-preview.tsx   # リアルタイムプレビューコンポーネント
```
